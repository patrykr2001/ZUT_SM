...
def plot_audio(Signal, Fs, TimeMargin=[0, 0.02]):
    # TODO: Implement functionW
    pass


def save_document(title, files):
    document = Document()
    document.add_heading(title, 0)  # tworzenie nagłówków druga wartość to poziom nagłówka
